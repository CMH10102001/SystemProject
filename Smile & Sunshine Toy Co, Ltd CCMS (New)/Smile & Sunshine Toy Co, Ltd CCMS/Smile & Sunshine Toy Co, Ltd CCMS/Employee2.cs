...
namespace Smile___Sunshine_Toy_Co__Ltd_CCMS
{
    public partial class Employee2 : Form
    {
        ...
        private void btnadd_Click(object sender, EventArgs e)
        {
            try
            {
                if (bookIDTextBox.Text != "" && titleTextBox.Text != "" && authorTextBox.Text != "" && publisherTextBox.Text != "" && textBox1.Text != "" && textBox2.Text != "" && textBox6.Text != "")
                {
                    UpdateGrid("Insert into Staff values (\"" + bookIDTextBox.Text + "\",\"" + titleTextBox.Text + "\",\"" + authorTextBox.Text + "\",\"" + publisherTextBox.Text + "\",\"" + textBox2.Text + "\"," + int.Parse(textBox6.Text) + ");");
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    UpdateGrid("Delete from Staff where Staff_Id = \"" + textBox7.Text + "\";");
                    UpdateGrid("Select * from Staff");
                }
            }
            catch (Exception E)
